...
//           }}
//           className="!overflow-visible px-4 sm:px-6"
//         >
//           {data?.map((item: any) => (
...
//                     <Link
//                       href={`/properties/${item.id}/wishlist`}
//                       onClick={(e) => e.stopPropagation()}
//                       className="absolute top-2 sm:top-3 md:top-5 right-2 sm:right-3 md:right-5 z-10"
//                     >
//                       <button
//                         onClick={(e) => e.stopPropagation()}
//                         className="p-2 sm:p-2.5 md:p-3.5 bg-white/90 backdrop-blur-md rounded-full text-gray-400 hover:text-red-500 shadow-sm transition-colors hover:bg-white"
//                       >
//                         <Heart
//                           size={16}
...
//         {/* DOT NAVIGATION - Show on all devices */}
//         {totalSlides > 1 && (
