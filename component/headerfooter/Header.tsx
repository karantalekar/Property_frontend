...
//     `transition ${isActiveRoute(path) ? "text-yellow-400" : "hover:text-yellow-400"
//     }`;
                  ...
                  >
                    ...
                    <div className="p-2">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-gray-100 transition text-left ${tab === "wishlist" ? "text-red-500" : ""}`}
                      >
                        <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center">
                          <Heart
                            size={18}
