  ...
  return (
    <>
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[160px] md:auto-rows-[160px] md:auto-rows-[180px] lg:auto-rows-[240px]">
          {/* MAIN IMAGE */}
          {mainImage && (
            <div
              className="col-span-2 md:col-span-2 row-span-2 rounded-xl md:rounded-2xl overflow-hidden cursor-pointer relative group"
              onClick={() => openModal(0)}
            >
              <Image
          ...
          {previewVideos.map((video, idx) => (
            <div
              key={`video-${idx}`}
              className="rounded-xl overflow-hidden bg-black cursor-pointer group"
      ...
      {/* MODAL - Swipeable on all devices */}
      <ImageModal
        isOpen={modalOpen}
