...
//     setPageProperties(allProperties.slice(start, end));
//   }, [allProperties, page]);
...
//         ?.toLowerCase()
//         .replace(/\s+/g, "-")
//         .replace(/[^\w-]/g, "") || `property-${property.id}`
//     );
//   };
...
//         <div className="hidden lg:flex lg:w-1/4 border-r border-slate-200 overflow-y-auto bg-gradient-to-b from-[#FFFBF1] to-white flex-col">
...
//           {/* Mobile Controls */}
//           <div className="lg:hidden flex items-center gap-2 p-4 border-b border-slate-200 bg-white sticky top-0 z-20">
//             <button
...
//         <div className="hidden lg:flex lg:w-1/4 overflow-hidden border-l border-slate-200 bg-slate-100 mr-5">
//           {loading ? (
//             <div className="w-full h-full flex items-center justify-center">
//               <div className="text-center">
//                 <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#FFFBF1] mb-4">
//                   <div className="w-6 h-6 rounded-full border-2 border-blue-200 border-t-black animate-spin"></div>
//                 </div>
//                 <p className="text-slate-600 font-medium">Loading map...</p>
//               </div>
//             </div>
