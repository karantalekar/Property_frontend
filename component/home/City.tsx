...
//         {/* Heading */}
//         <div className=" container mx-auto flex items-center gap-6 mb-4 ">
...
export default function City({ cities }: { cities: any[] }) {
    ...
    return (
      <section className="py-12 px-6 bg-white  -mt-10">
        <div className="container mx-auto">
          {/* Heading */}
          <div className="flex items-center gap-6 mb-4 md:-mt-4">
            <h2 className="text-2xl md:text-4xl text-gray-900 ">
              Trending destinations
            </h2>
            <div className="flex-1 h-[2px] bg-gray-300"></div>
  ...
  return (
    <section className="bg-white">
      <div className="container mx-auto px-6 lg:px-0 py-15">
        {/* Heading */}
        <div className="flex items-center gap-6 mb-10">
          <h2 className="text-5xl text-gray-900">Trending destinations</h2>
          <div className="flex-1 h-[2px] bg-gray-300"></div>
        </div>
          ...
          {cities?.map((city) => (
            <div key={city.id} className="group cursor-pointer">
              ...
              <div className="flex justify-between items-center mt-5">
                <h3 className="text-2xl font-medium text-black">{city.name}</h3>
