    ...
    <section className="w-full py-5 md:py-10 bg-white overflow-hidden">
      <div className="w-full px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 -mt-5 md:grid-cols-12 gap-6 md:auto-rows-[250px]">
          {/* Left Large Image */}
          <div className="md:col-span-6 md:row-span-2 rounded-[2.5rem] overflow-hidden shadow-sm h-[450px] md:h-[110%]  relative">
            <img
          ...
          <div className="md:col-span-3 md:row-span-2 bg-[#edd6ad] rounded-[2.5rem] md:w-[100%] p-8 md:p-15 md:h-115 h-78 flex flex-col justify-center items-center text-center">
          ...
          <div className="md:col-span-3 md:row-span-1 rounded-[2.5rem] overflow-hidden h-[200px] md:h-[90%] relative">
            <img
          ...
          <div className="md:col-span-3 md:row-span-1 bg-[#8B6E5B] rounded-[2.5rem] p-8 md:-mt-5 flex md:h-50 items-center justify-center text-center">
